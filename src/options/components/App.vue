        ...
        <div class="settings-block">
          ...
          <div class="settings-block-main">
            ...
            <div class="settings-group">
              ...
              <input id="options-code-regexhttpRequest" type="text" v-model="options.code.regexHTTPrequest" @change="save" placeholder="Exemple : /.*localhost.*token.*/gm">
              <small>Use regex to filter http request that you wouldn't record</small>
            </div>
            <div class="settings-group">
              <label>
                <input id="options-code-recordHTTPrequest" type="checkbox" v-model="options.code.recordHttpRequest" @change="save">
  ...
  export default {
    ...
    methods: {
      exportSettings() {
         ...
         let blob = new Blob([JSON.stringify(this.options.code, null, 2)], { type: "application/json"});
